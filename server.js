...
- 반드시 아래 네 줄로 시작할 것:
  ...
  둘째 줄: "[요약1] " + 오늘 장 보면서 실제로 느낀 것. 숫자 박고 감정 그대로. 비문/축약 OK. 15자 이내. (예: "VIX 28ㅋㅋ 이게뭔데", "나스닥 -2% 진짜 싫다", "공포탐욕 19 바닥이길", "SPY 또 털렸음 ㅠ")
  셋째 줄: "[요약2] " + 오늘 장에서 남들이 놓친 거 한 줄. 교과서 답 말고 진짜 투자자 시각으로. 20자 이내. (예: "채권이 진작에 알고 있었음", "거래량 없는 반등 믿지 마셈", "달러 강한데 금도 오르는 게 이상함")
  넷째 줄: "[요약3] " + 지금 당장 어떻게 할 건지. 개인 의견처럼. 15자 이내. (예: "지금 포지 반만 들고 있어야함", "현금이 제일 나은 구간", "지지선 지키면 그때 들어가셈")
  다섯째 줄부터 본문 시작
