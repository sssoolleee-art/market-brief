...
- 반드시 아래 네 줄로 시작할 것:
  ...
  둘째 줄: "[요약1] " + 오늘 장 보면서 실제로 느낀 것. 숫자 박고 감정 그대로. 비문/축약 OK. 25자 이내. 감탄사(ㅋㅋ/ㅠ)는 3줄 중 최대 1번만. (예: "VIX 28인데 나스닥은 버티고 있음 이게 맞나", "공포탐욕 19까지 내려왔는데 SPY는 지지선 지킴", "오늘 -2% 맞았는데 거래량이 별로 없었음")
  셋째 줄: "[요약2] " + 오늘 장에서 남들이 놓친 거 한 줄. 교과서 답 말고 진짜 투자자 시각으로. 30자 이내. (예: "채권이 주식보다 먼저 바닥 신호 줬는데 아무도 얘기 안 함", "거래량 없는 반등은 안 믿는 게 맞음, 오늘도 그랬음", "달러 강한데 금도 같이 오른다는 게 뭔가 다른 신호임")
  넷째 줄: "[요약3] " + 지금 당장 어떻게 할 건지. 개인 의견처럼. 20자 이내. (예: "지금 구간은 포지 반만 들고 버티는 게 맞음", "현금 비중 늘리고 다음 주 지표 보고 판단할 생각", "지지선 지켜주면 그때 분할로 들어갈 생각임")
  다섯째 줄부터 본문 시작
...
- 반드시 아래 네 줄로 시작할 것:
  ...
  둘째 줄: "[요약1] " + 이번 주 버티면서 실제로 느낀 것. 숫자 박고 감정 그대로. 비문/축약 OK. 25자 이내. 감탄사는 3줄 중 최대 1번만. (예: "이번 주 VIX 32까지 튀었다가 결국 닫힘, 멘탈 탔음", "주간 -3% 맞았는데 금요일에 절반 회복해서 겨우 버팀")
  셋째 줄: "[요약2] " + 이번 주 남들이 놓친 거 한 줄. 교과서 답 말고 진짜 시각으로. 30자 이내. (예: "기술주 빠지는 동안 에너지만 혼자 올랐는데 아무도 얘기 안 함", "달러 강세인데 금도 같이 오른 한 주, 이게 정상이 아님")
  넷째 줄: "[요약3] " + 다음 주 어떻게 할 건지 개인 의견처럼. 20자 이내. (예: "FOMC 전까진 관망이 맞고 결과 보고 다시 판단할 생각", "200MA 지켜주면 비중 유지, 깨지면 빠르게 줄일 생각")
  다섯째 줄부터 본문 시작
...
- 반드시 아래 네 줄로 시작할 것:
  ...
  둘째 줄: "[요약1] " + 다음 주 앞두고 지금 느끼는 것. 숫자/이벤트 박고 감정 그대로. 비문/축약 OK. 25자 이내. 감탄사는 3줄 중 최대 1번만. (예: "FOMC + 어닝 3개 겹친 주, 포지션 잡기가 제일 어려움", "이번 주 털렸는데 다음 주 NVDA 어닝까지 있어서 더 무서움")
  셋째 줄: "[요약2] " + 다음 주 남들이 놓칠 핵심 변수 1개. 교과서 답 말고. 30자 이내. (예: "연준 발표보다 그 이후 달러 반응이 진짜 방향을 알려줄 것", "어닝 숫자보다 가이던스가 주가 방향 결정할 가능성이 높음")
  넷째 줄: "[요약3] " + 월요일 장 전 어떻게 할 건지 개인 의견처럼. 20자 이내. (예: "갭업이면 절반 정리하고 이벤트 지켜볼 생각", "200MA 위면 홀딩, 깨지면 즉시 비중 줄일 생각")
  다섯째 줄부터 본문 시작
